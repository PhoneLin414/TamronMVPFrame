...
import com.example.tamronmvpframe.databinding.FragmentChannelDetailBinding;
...
public class ChannelDetailFragment extends Fragment implements FeedsListDelegate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        createMockData();
        fragmentChannelDetailBinding = FragmentChannelDetailBinding.inflate(getLayoutInflater());
        View view = fragmentChannelDetailBinding.getRoot();
        RecyclerView rv_home_feeds = fragmentChannelDetailBinding.rvChannelDetailFeeds;
        if (getActivity() != null) {
